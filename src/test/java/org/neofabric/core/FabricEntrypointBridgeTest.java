...
public final class FabricEntrypointBridgeTest {
    public static void main(String[] args) throws Exception {
        ...
        try (var output = new JarOutputStream(Files.newOutputStream(jar))) {
            write(output, "fabric.mod.json", "{\"schemaVersion\":1,\"id\":\"fixture\",\"version\":\"1\",\"mixins\":[\"fixture.mixins.json\"],\"entrypoints\":{\"main\":[\"fixture.ModEntry\"],\"neofabric:registry\":[\"fixture.ModEntry\"]}}");
        ...
        try (var modLoader = new CompatibilityClassLoader(jar, FabricEntrypointBridgeTest.class.getClassLoader())) {
            ...
            assert initialized.equals(java.util.List.of("fixture.ModEntry"));
